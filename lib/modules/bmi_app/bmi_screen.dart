import 'dart:math';
import 'package:bmi_calc/modules/bmi_app/bmi_result_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('BMI Calculator',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25.0,color: Colors.white),),
      ),
      body: Container(
